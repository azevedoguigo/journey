...
const insetTrip = `-- name: InsetTrip :one
INSERT INTO trips
...
func (q *Queries) InsetTrip(ctx context.Context, arg InsetTripParams) (uuid.UUID, error) {
	row := q.db.QueryRow(ctx, insetTrip,
		arg.Destination,
		arg.OwnerEmail,
		arg.OwnerName,
		arg.StartsAt,
